...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'questions' | 'upload' | 'participants'>('questions');
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 p-6 md:p-8" id="admin-panel-card">
      ...
      <div className="flex gap-1 p-1 bg-slate-100 border border-slate-200 rounded-lg max-w-md mb-8">
        <button
